...
function HudMethods:renderStaffList(ctx)
    ...
    local sl = create("Frame", {
        Name = "StaffList", Size = UDim2.fromOffset(170, 40), Position = UDim2.new(0, 20, 0, 330),
...
function HudMethods:renderTargetHud(ctx)
    ...
    local function createBar(pos, color)
        local b = create("Frame", { Position = pos, Size = UDim2.new(1, -24, 0, 14), BackgroundColor3 = Color3.fromRGB(45, 45, 45), Parent = th, BackgroundTransparency = 1 })
        create("UICorner", {CornerRadius = UDim.new(0, 4)}, b)
        local f = create("Frame", { Size = UDim2.new(0, 0, 1, 0), BackgroundColor3 = color, Parent = b, BackgroundTransparency = 1 })
        create("UICorner", {CornerRadius = UDim.new(0, 4)}, f)
        local t = create("TextLabel", { Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1, Text = "", TextColor3 = Color3.new(1,1,1), Font = Enum.Font.GothamBold, TextSize = 10, Parent = b, TextTransparency = 1, ZIndex = 3 })
        return b, f, t
    end

    local hpB, hpF, hpT = createBar(UDim2.fromOffset(12, 32), Color3.fromRGB(255, 85, 85))
    local apB, apF, apT = createBar(UDim2.fromOffset(12, 50), Color3.fromRGB(85, 200, 255))

    local ragLabel = create("TextLabel", { Position = UDim2.fromOffset(12, 68), Size = UDim2.new(1, -24, 0, 16), BackgroundTransparency = 1, Text = "", TextColor3 = Color3.fromRGB(255, 150, 50), Font = 18, TextSize = 11, TextXAlignment = 0, Parent = th, TextTransparency = 1 })
